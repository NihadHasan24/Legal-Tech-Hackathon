...
// Listen before connecting so early requests wait on Mongoose's queue instead of getting ECONNREFUSED.
const server = app.listen(port, host, () => console.log(`DLAS API listening on http://${host}:${port}`))
try {
