...
router.get('/applications/:applicationId/incidents', applicationIdParam, requireRole('DLAO_OFFICER'), applicationGroups)
...
router.get('/applications/:applicationId/duplicates', applicationIdParam, requireRole('DLAO_OFFICER'), duplicateCandidates)
...
router.get('/incidents/:groupId', incidentGroupIdParam, requireRole('DLAO_OFFICER'), readGroup)
