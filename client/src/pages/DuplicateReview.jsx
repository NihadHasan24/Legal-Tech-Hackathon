...
export default function DuplicateReview({ applicationId, token }) {
  ...
  return <Panel id="duplicate-title" en="Possible duplicates" bn="একই ব্যক্তির হতে পারে এমন আবেদন" hint={hint}>
    <p className="muted"><Bi en="Shows similarity only, not proof. Records are never merged." bn="তথ্যে মিল থাকলেই আবেদনকারী একই ব্যক্তি প্রমাণ হয় না। দুটি আবেদন আলাদা থাকবে; একজন কর্মী যাচাই করবেন।" /></p>
